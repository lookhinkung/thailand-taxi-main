                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="group_name" class="form-select mb-3"
                                            ...
                                            <option value="Manage Comment">
                                                {{ $permission->group_name == 'Manage Comment' ? 'selected' : '' }}Manage Comment
                                            </option>
                                            <option value="Booking Report">
                                                {{ $permission->group_name == 'Booking Report' ? 'selected' : '' }}Booking Report
                                            </option>
        
                                            <option value="Contact Message">
                                                {{ $permission->group_name == 'Contact Message' ? 'selected' : '' }}Contact Message
                                            </option>
