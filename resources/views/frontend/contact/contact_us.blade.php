            ...
            <div class="col-lg-6">
                <div class="contact-another-content">
                    <div class="section-title">
                        <h2>Contacts Info</h2>
                        <p>
                            Any further questions or you're interested in one of the services that we provide, and queries you may have, please don't hesitate to message us. We will back to you very soon.
                        </p>
                    </div>
                    ...
                    <div class="contact-item">
                        <ul>
                            ...
                            <li>
                                ...
                                <div class="content">
                                    <span><a href="{{$setting->whatsapp}}">{{$setting->whatsapp}}</a></span>
                                    {{-- <span><a href="{{$setting->email}}">{{$setting->email}}</a></span> --}}
                                    <br>
                                </div>
                            ...
                            <li>
                                ...
                                <div class="content">
                                    <span><a href="{{$setting->facebook}}">{{$setting->facebook}}</a></span>
                                    {{-- <span><a href="{{$setting->email}}">{{$setting->email}}</a></span> --}}
                                    <br>
                                </div>
